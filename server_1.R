...
source("./manipulation/1-dataprep-for-shiny.R") 
...
# Creates the reactive object contaning the strings of dataset names to be used later
  dsTag <- reactive({
    switch(EXPR=input$dataset,
           "Version with 49 items" = "R_49",
           "Version with 10 items" = "R_10"
...
# Dataset description
  datasetDescription <- reactive({
    switch(EXPR=input$dataset,
           "Version with 49 items"=dscr.R_49,
           "Version with 10 items"=dscr.R_10
...
# Number of observed variables
  p <- reactive({
    switch(EXPR=input$dataset,
           "Version with 49 items" = p.R_49,
           "Version with 10 items" = p.R_10
...
# Sample size
  n <- reactive({
    switch(EXPR=input$dataset,
           "Version with 49 items" = n.R_49,
           "Version with 10 items" = n.R_10
...
inputDatavars <- reactive({
  switch(EXPR=input$dataset,
         "Version with 49 items" ="cognitive_03.png",
         "Version with 10 items" ="emotional_03.png"
