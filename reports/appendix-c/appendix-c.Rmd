---
title: "Appendix C: Review Variables"
output:
  html_document:
...
read_chunk("./reports/appendix-c/appendix-c.R") 
```
...
# Variables
```{r print-meta-1, echo=FALSE, results='asis', message=FALSE}
```

```{r demo, echo=FALSE, results='asis', message=FALSE}
```

```{r foc, echo=FALSE, results='asis', message=FALSE, out.width ="620px"}
```

```{r interventions, echo=FALSE, results='asis', message=FALSE, out.width ="620px"}
```
